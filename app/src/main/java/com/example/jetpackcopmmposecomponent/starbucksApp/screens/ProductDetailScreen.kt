...
private fun ProductHeader(
    ...
    Row(
        ...
        AppIconComponent(icon = R.drawable.back, onClick = { onClick() })
...
private fun ShowProduct() {
    ...
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .background(color = LightRed_1, shape = RoundedCornerShape(14.dp)),
        ...
        Column(
            ...
            Box(
                ...
                Row {
                    AppIconComponent(icon = R.drawable.plus, backgroundColor = DarkGreen) {
                        counter++
                    }
                    ...
                    Spacer(modifier = Modifier.width(10.dp))
                    AppIconComponent(icon = R.drawable.minus, backgroundColor = DarkGreen) {
                        if (counter > 0)
                            counter--
                    }
                }
...
fun ProductDescription(modifier: Modifier = Modifier) {
    Column(
        ...
        Text(
            text = stringResource(R.string.coffee),
            style = TextStyle(
                fontSize = 18.sp,
                color = DarkGreen
            )
